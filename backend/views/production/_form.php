   ...
   // 'attribute' => 'Date',
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <i class="fa fa-envelope"></i> Physical Lab Data Collecting
        ...
        <div class="panel-body container-items"><!-- widgetContainer -->
            ...
            <div class="item panel panel-default"><!-- widgetBody -->
                    <div class="panel-heading">
                        <span class="panel-title-address">Phisical Lab Data Collecting <?=($i + 1) ?></span>
                    ...
                    <button type="button" class="pull-right add-item btn btn-success btn-xs"><i class="fa fa-plus"></i> Add Physical Lab Data</button>        
                </div>
            </div>
             <?php endforeach; ?>
            </div>
